...
namespace Shifter.Persistence.Data
{
    public class DatabaseFactory : IDatabaseFactory
    {
        ...
        {
            sessionFactory = Fluently.Configure().Database(MsSqlConfiguration.MsSql2008.ConnectionString(c => c.FromConnectionStringWithKey("ShifterConnection")).Driver("NHibernate.Driver.Sql2008ClientDriver"))
