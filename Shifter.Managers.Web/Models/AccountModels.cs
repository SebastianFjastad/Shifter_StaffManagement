...
namespace Shifter.Managers.Web.Models
{
    #region Models
    ...
    /// <summary>
    /// Membership service that exposes methods for validating and creating users and changing passwords
    /// </summary>
    public interface IMembershipService
    {
        ...
        MembershipUser LoadUser(string username);
    ...
    public class AccountMembershipService : IMembershipService
    {
        ...
        public bool DeleteUser(string userName)
        {
            ...
            var deleted = provider.DeleteUser(userName, true);
            return deleted;
        }
        ...
        public MembershipUser LoadUser(string username)
        {
            return provider.GetUser(username, false);
        }
    }
    ...
    /// <summary>
    /// Authentication service for signing in and out
    /// </summary>
    ...
    /// <summary>
    /// Used for account validation to return a message based off a provided error code
    /// </summary>
    public static class AccountValidation
    {
        /// <summary>
        /// Returns string messages for know errors
        /// </summary>
    ...
    public sealed class ValidatePasswordLengthAttribute : ValidationAttribute, IClientValidatable
    {
        ...
        /// <summary>
        /// Checks if the provided password is valid according to the validation rules
        /// </summary>
        ...
        /// <summary>
        /// Gets the current configured validation rules from 
        /// </summary>
